...
const _log = (type = "log", content) => {
    ...
    switch (type) {
        case "log": {
            return console.log(`[${process.env.NODE_ENV.toUpperCase()}] ${timestamp}: ${chalk.blue(type.toUpperCase())}`, ...content)
        }
        case "warn": {
            return console.log(`[${process.env.NODE_ENV.toUpperCase()}] ${timestamp}: ${chalk.yellow(type.toUpperCase())}`, ...content)
        }
        case "error": {
            return console.log(`[${process.env.NODE_ENV.toUpperCase()}] ${timestamp}: ${chalk.red(type.toUpperCase())}`, ...content)
        }
        case "ready": {
            return console.log(`[${process.env.NODE_ENV.toUpperCase()}] ${timestamp}: ${chalk.green(type.toUpperCase())}`, ...content)
        }
        default:
