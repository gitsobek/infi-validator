...
module.exports = (load) => {
    ...
    load('isUUIDv2', 'general', function (value) {
        return /^[0-9A-F]{8}-[0-9A-F]{4}-[2][0-9A-F]{3}-[89AB][0-9A-F]{3}-[0-9A-F]{12}$/i.test(value);
    });

    load('isUUIDv3', 'general', function (value) {
        return /^[0-9A-F]{8}-[0-9A-F]{4}-[3][0-9A-F]{3}-[89AB][0-9A-F]{3}-[0-9A-F]{12}$/i.test(value);
    });
    ...
    load('isUUIDv5', 'general', function (value) {
